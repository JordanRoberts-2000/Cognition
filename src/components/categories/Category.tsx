        ...
        <div className="aspect-video md:aspect-square flex flex-col rounded-md customShadow">
            ...
            <div className="border-slate-200 border p-2 flex items-center">
                <div className="flex gap-4 border border-slate-300 rounded-md px-2 p-1">
                    <svg className="w-6 h-6 stroke-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5}>
                ...
                <div className="ml-auto flex gap-6">
                    <svg className="w-5 h-5 stroke-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
