...
const Category = ({title}: Props) => {
    return (
        <div className="aspect-video md:aspect-square flex flex-col border border-slate-400">
            ...
            <div className="border-slate-200 border p-2 flex">
                ...
                <svg className="w-6 h-6 ml-auto stroke-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
